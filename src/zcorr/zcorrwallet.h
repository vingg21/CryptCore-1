...
#ifndef CRYPTCORE_ZCORRWALLET_H
#define CRYPTCORE_ZCORRWALLET_H
...
public:
    ...
    void GenerateDeterministicZCORR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCORR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
