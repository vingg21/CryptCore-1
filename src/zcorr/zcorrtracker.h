...
#ifndef CRYPTCORE_ZCORRTRACKER_H
#define CRYPTCORE_ZCORRTRACKER_H
...
public:
    CzCORRTracker(CWallet* parent);
    ~CzCORRTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCORRWallet* zCORRWallet = NULL);
...
#endif //CRYPTCORE_ZCORRTRACKER_H
