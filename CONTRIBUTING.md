Contributing to CRYPTCORE Core
============================

The CRYPTCORE Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Cryptcore/cryptcore/blob/master/doc/translation_process.md)
...
The following applies to code changes to the CRYPTCORE Core project, and is not to be
confused with overall CRYPTCORE Network Protocol consensus changes.

Whether a pull request is merged into CRYPTCORE Core rests with the project merge
...
The project leader is the release manager for each CRYPTCORE Core release.
