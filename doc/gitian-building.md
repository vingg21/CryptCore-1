...
*Setup instructions for a gitian build of CRYPTCORE Core using a VM or physical system.*
...
- [Building CRYPTCORE Core](#building-cryptcore-core)
...
[gitian.sigs](https://github.com/Cryptcore/gitian.sigs/) repository:
...
You can also mail the files to Fuzzbawls (fuzzbawls@cryptcore.com) and he will commit them.
