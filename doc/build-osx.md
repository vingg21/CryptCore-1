...
Build CRYPTCORE Core
------------------------

1. Clone the CRYPTCORE Core source code:

        git clone https://github.com/Cryptcore/cryptcore
        cd cryptcore
...
CRYPTCORE Core is now available at `./src/cryptcored`
